...
make_sim <- function(i, df) {
  message(sprintf("Progress: %d/%d, %.2f%%", i, nrows, i / nrows * 100))
  the_snp <- df[i]
...
fwrite(comp, "/nfs/research/birney/users/saul/outputs/heart_rate_tmp_manuscript_data/simulation_gxg/ukb_height_sim_example_result.csv.gz")
